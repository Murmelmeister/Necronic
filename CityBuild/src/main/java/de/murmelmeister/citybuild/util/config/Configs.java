...
public enum Configs {
    ...
    PERMISSION_SELL("Permission.Sell", "netherlegends.command.sell"),
    PERMISSION_ITEM_VALUE_COMMAND("Permission.ItemValue.Command", "netherlegends.command.itemvalue.command"),
    PERMISSION_ITEM_VALUE_GET("Permission.ItemValue.Get", "netherlegends.command.itemvalue.get"),
    PERMISSION_ITEM_VALUE_SET("Permission.ItemValue.Set", "netherlegends.command.itemvalue.set"),
