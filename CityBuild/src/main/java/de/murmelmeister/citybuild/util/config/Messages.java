...
public enum Messages {
    ...
    SCOREBOARD_SCORE_11("Scoreboard.Score.11", "&8» &eCityBuild"),
    SCOREBOARD_SCORE_10("Scoreboard.Score.10", "&3"),
    SCOREBOARD_SCORE_9("Scoreboard.Score.9", "&8| &6Your rank:"),
    SCOREBOARD_SCORE_8("Scoreboard.Score.8", "&8» &cComing Soon"),
    SCOREBOARD_SCORE_7("Scoreboard.Score.7", "&2"),
    SCOREBOARD_SCORE_6("Scoreboard.Score.6", "&8| &6Your coins:"),
