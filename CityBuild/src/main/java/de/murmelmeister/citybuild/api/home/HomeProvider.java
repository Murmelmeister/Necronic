...
public final class HomeProvider implements Home {
    ...
    public boolean existsHome(int userId, String homeName) {
        return database.existsCallable(Procedure.HOME_GET.getName(), userId, homeName);
    }
    ...
    public void addHome(int userId, String homeName, Location location) {
        ...
        database.updateCallable(Procedure.HOME_ADD.getName(), userId, homeName, worldName, environment, x, y, z, yaw, pitch);
    }

    @Override
    public void removeHome(int userId, String homeName) {
        database.updateCallable(Procedure.HOME_REMOVE.getName(), userId, homeName);
    }

    @Override
    public Location getHome(Server server, int userId, String homeName) {
        return database.queryCallable(Procedure.HOME_GET.getName(), null, resultSet -> {
    ...
    public List<String> getHomeNames(int userId) {
        return database.queryListCallable(Procedure.HOME_GET_ALL.getName(), new ArrayList<>(), resultSet -> resultSet.getString("HomeName"), userId);
    }
